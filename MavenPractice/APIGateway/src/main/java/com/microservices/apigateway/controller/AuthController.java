...
import com.microservices.apigateway.model.AuthResponse;
...
public class AuthController {
  ...
  public ResponseEntity<AuthResponse> login(
      @RegisteredOAuth2AuthorizedClient("okta") OAuth2AuthorizedClient client, @AuthenticationPrincipal OidcUser user) {
